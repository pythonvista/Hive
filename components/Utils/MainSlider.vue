            ...
            <swiper-slide v-for="i in 20" :key="i" class="overflow-hidden rounded-md   ">
                 <div class="relative w-full overflow-hidden bg-white rounded-lg shadow-lg group">
                    <div class="absolute z-10 top-5 left-5">
                        <div class="inline-flex items-center justify-center text-xs font-bold text-white bg-gray-800 rounded-full w-9 h-9">Sale</div>
                    </div>
                    <div class="overflow-hidden aspect-w-4 aspect-h-3">
                        <img class="object-cover w-full h-full transition-all duration-300 group-hover:scale-125" src="https://i.imgur.com/YfLrbyv.jpg" alt="" />
                    </div>
                    <div class="px-5 py-5">
                        <h3 class="text-base text-left font-bold text-gray-900">
                            <a href="#" title="">
                                Room Self Contain
                                <span class="absolute inset-0" aria-hidden="true"></span>
                            </a>
                        </h3>
                        <div class="flex mt-1.5 items-center justify-between space-x-4">
                            <div class="flex items-start justify-start flex-col ">
                                <p class="text-sm font-bold text-gray-900">₦129,000</p>
